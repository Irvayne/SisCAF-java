  			...
  			<span aria-hidden="true">&times;</span>
				...
				<div class="card mb-3">
					<div class="card-header">
						<i class="fa fa-table"></i> Professores Cadastrados
						<div></div>
								...
								<tbody>
									<c:forEach items="${lista}" var="var">
										<tr>
											...
											<td>${var.sexo}</td>
											<td>${var.curso}</td>
											<td ><a id="deletar" href="/siscaf/professor/${var.id}/deletar"
												class="btn btn-danger"> <i class="fa fa-fw fa-remove">
												</i> 
											</a> <a id="editar"  href="/siscaf/professor/${var.id}/editar"  class="btn btn-primary">
